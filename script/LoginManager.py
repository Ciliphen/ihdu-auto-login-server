...
class LoginManager:
    def __init__(self,
                 ...
                 url_login_page="http://192.168.112.30/srun_portal_pc?ac_id=0&theme=pro",
                 url_get_challenge_api="http://192.168.112.30/cgi-bin/get_challenge",
                 url_login_api="http://192.168.112.30/cgi-bin/srun_portal",
                 n="200",
                 vtype="1",
                 acid="0",
                 enc="srun_bx1"
